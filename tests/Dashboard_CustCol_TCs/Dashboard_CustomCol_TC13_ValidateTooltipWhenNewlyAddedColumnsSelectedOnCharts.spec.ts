...
import { DashboardPage, AxisType} from '../../utils/pages/DashboardPage';
...
import { DashboardPage_Locators } from '../../utils/pages/DashboardPage';
...
test('Dashboard - Validate Tooltip When Newly Added Columns Selected on Charts', async ({ page }) => {
  ...
  // Validate Tooltip appears with column name when the newly added column is selected on charts
  await dashboardHelper.selectOnlyNewColumnAndValidateTooltip(DashboardPage_Locators.dashboardColumnChart, AxisType.Y_AXIS,columnName,true );
  await dashboardHelper.selectOnlyNewColumnAndValidateTooltip(DashboardPage_Locators.dashboardBarChart, AxisType.X_AXIS,columnName,true );
  await dashboardHelper.selectOnlyNewColumnAndValidateTooltip(DashboardPage_Locators.dashboardStackedColumnChart,AxisType.Y_AXIS,columnName, true );
  await dashboardHelper.selectOnlyNewColumnAndValidateTooltip(DashboardPage_Locators.dashboardColumnLineComboChart,AxisType.Y_AXIS, columnName,true );
